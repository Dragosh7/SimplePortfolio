...
repoList =
    [ { name = "First project"
    , description = Just "Elm - functional programming"
    , url = "https://github.com/Dragosh7"
    , pushedAt = "Sep"
    , stars = 5
      }
    ]
...
personalDetails =
    ...
    , contacts = [ DetailWithName "email:" " tecuci.va.dragos@student.utcluj.ro" ]
    , socials = [ DetailWithName "github" "https://github.com/Dragosh7" ]
    }
